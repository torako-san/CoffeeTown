class ShopProduction
  ...
  attr_accessor :shop_name, :shi_ku_gun, :chome_banchi, :shop_url, :prefectures, :user_id, :production_name, :purchase_date, :coffee_beans_type, :farm_name, :product_report, :product_category, :coffee_blend, :degree_of_roasting, :country_of_origin, :carefully_selected_method, :sweetness, :acidity, :bitter_taste, :flavor, :shop_id, :images
  ...
  validates :images, length: { minimum: 1, maximum: 3, message: "は1枚以上3枚以下にしてください" }, allow_blank: true
